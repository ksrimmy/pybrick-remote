...
motorL.control.limits(acceleration=400)
motorR.control.limits(acceleration=400)
...
while True:
    ...
    if keyboard.poll(0):
        ...
        if data[-1] == "\n":
            ...
            # else:
            # Control steering using the left - and + buttons.
            angle = -60 if "lft" in cmd_arr else (60 if "rgt" in cmd_arr else 0)
            speed = 500 if "fwd" in cmd_arr else (-500 if "rev" in cmd_arr else 0)
